            ...
            <form @submit.prevent="register">
                <div class="bg-white rounded-md shadow-md p-5">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" v-model="user.nohp"
                            class="mt-2 appearance-none w-full bg-gray-200 border border-gray-200 rounded h-7 shadow-sm placeholder-gray-600 focus:outline-none focus:placeholder-gray-600 focus:bg-white focus-within:text-gray-600 p-5"
                    ...
                    <div>
                        <button
                            class="bg-green-700 py-1 px-3 text-white rounded-md shadow-md text-xl inline-block w-full focus:outline-none focus:bg-green-900" style="background-color: #467F4D;">DAFTAR</button>
                    </div>
            ...
            function register() {
               ...
               //panggil actions "register" dari module "auth"
                ...
                .then(() => {
                    ...
                    //show validation no hp with toast
                    if(validation.value.nohp) {
                        toast.error(`${validation.value.nohp[0]}`)
                    }
