                                  ...
                                  <div class="w-full pt-6 p-5 md:p-3 text-center md:text-left space-y-4">
                                      ...
                                      <div class="font-medium">
                                              ...
                                              <div v-for="donation in campaign.sum_donation" :key="donation">
                                                  ...
                                                  <div class="relative pt-1">
                                                      <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-green-200">
                                                          <div :style="{width: percentage(donation.total, campaign.target_donation) + '%'}" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-green-500"></div>
                                                      </div>
                                                  </div>
  
                                                  <p class="text-xs text-gray-500">
                                                      <span class="font-bold text-green-400">Rp. {{ formatPrice(donation.total) }} </span> terkumpul dari
                                          ...
                                          <div v-else>
                                              ...
                                              <div class="relative pt-1">
                                                  <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-green-200" style="background-color: #C9E099;">
                                                      <div :style="{width: percentage(0, campaign.target_donation) + '%'}" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-green-500" style="background-color: #467F4D;"></div>
                                                  </div>
                                              </div>
  
                                              <p class="text-xs text-gray-500">
                                                  <span class="font-bold text-green-400" style="color: #467F4D;">Rp. 0 </span> terkumpul dari
                                                  <span class="font-bold">Rp. {{ formatPrice(campaign.target_donation) }}</span>
                                              </p>
                                          </div>
                                          ...
                                          <router-link :to="{name: 'campaign.show', params:{slug: campaign.slug }}">
                                            <button class="bg-green-700 mt-3 px-2 py-1 rounded shadow-md text-white text-xs" style="background-color: #467F4D;">Donasi Sekarang!</button>
                                        </router-link>
                                      </div>
                                  </div>
                              </div>
