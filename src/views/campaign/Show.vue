        ...
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white rounded-md shadow-md p-3">
                ...
                <div v-if="maxDate(campaign.max_date) == true">
                    <div class="mt-5">
                        <button
                            class="bg-yellow-500 py-3 rounded-md shadow-md text-xl w-full font-bold focus:outline-none opacity-50 cursor-not-allowed">Donasi Ditutup!</button>
                    </div>
                </div>
                <div v-else>
                    <div class="mt-5">
                        <router-link :to="{name: 'donation.create', params:{slug: route.params.slug}}">
                            <button class="bg-yellow-500 py-2 rounded-md shadow-md text-xl w-full font-bold focus:outline-none focus:bg-yellow-600">Donasi 
                            Sekarang!  </button>
                        </router-link>
                    </div>
                </div>
                ...
                <div class="bg-gray-200 p-3 rounded shadow-md mb-3">
                    ...
                    <div class="grid grid-cols-10 gap-4">
                        ...
                        <div class="col-span-8 text-lg font-bold mt-6">
                            {{ user.name }}
                            <p class="text-sm font-semibold">Dari Pondok Pesantren Assalam</p>
                        </div>
                    </div>
                </div>
