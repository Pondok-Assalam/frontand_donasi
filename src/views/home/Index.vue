                                ...
                                <div class="w-full pt-6 p-5 md:p-3 text-center md:text-left space-y-4">
                                    ...
                                    <div class="font-medium">
                                        ...
                                        <div v-else>
                                            ...
                                            <div class="relative pt-1">
                                                <div class="overflow-hidden h-2 mb-4 text-xs flex rounded" style="background-color: #C9E099;">
                                            ...
                                            <p class="text-xs text-gray-500">
                                                <span class="font-bold" style="color: #467F4D;">Rp. 0 </span> terkumpul dari
                                                <span class="font-bold">Rp. {{ formatPrice(campaign.target_donation) }}</span>
                                            </p>
                                        </div>
                                        ...
                                        <router-link :to="{name: 'campaign.show', params:{slug: campaign.slug }}">
                                            <button class="mt-3 px-2 py-1 rounded shadow-md text-white text-xs" style="background-color: #467F4D;">Donasi Sekarang!</button>
                                        </router-link>
                                    </div>
                                </div>
                            </div>
